...
const translations = {
    en: {
        ...
        desk_experguru: "- ✔ Compiling learning documents such as Annual Programs (Prota), Semester Programs (Promes), Syllabuses, and Learning Implementation Plans (RPP)/Teaching Modules <br>✔ Designing industrial competency-based teaching materials, such as network basics, WAN, System Administration, Robotics Basics. <br> ✔ Carrying out teaching and learning activities (KBM) both theory and practice in the laboratory..",
    ...
    id: {
        ...
        desk_experguru: " Menyusun dokumen pembelajaran seperti Program Tahunan (Prota), Program Semester (Promes), Silabus, dan Rencana Pelaksanaan Pembelajaran (RPP)/Modul Ajar.<br> Merancang materi ajar berbasis kompetensi industri, seperti dasar jaringan, WAN, dan keamanan siber <br> Melaksanakan kegiatan belajar mengajar (KBM) baik teori maupun praktik di laboratorium.",
